...
const CaptainSignup = () => {
  ...
  const submitHandler = async (e) => {
    ...
    formData.append('fullname[firstname]', firstName); // Send firstname
    formData.append('fullname[lastname]', lastName);  // Send lastname
    ...
    <div className="py-5 px-5 h-screen flex flex-col justify-between">
      <div>
        ...
        <form onSubmit={submitHandler}>
          <h3 className="text-lg w-full font-medium mb-2">Captain Details</h3>
