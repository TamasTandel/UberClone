...
const VehiclePanel = ({
  ...
  const [selectedFee, setSelectedFee] = useState(null); // Fee for selected vehicle
      ...
      {[
        ...
        <div
          ...
          onClick={() => {
            ...
            setSelectedVehicleImage(vehicle.image); // Pass selected vehicle image
            setSelectedFee(fee); // Set fee for the selected vehicle
            setFee(fee); // Pass the fee back to parent component
          }}
