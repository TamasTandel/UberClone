        ...
        <div className="flex flex-col gap-2 justify-between items-center">
          <div className="flex justify-between w-full items-center">
            ...
            <div className="text-right">
              <h2 className="font-bold text-lg">{ride?.captain?.name || "Driver Name"}</h2>
              <h4 className="font-bold text-xl">{ride?.captain?.plateNumber || "GJ 00 XX 0000"}</h4>
              <p className="text-sm text-gray-700">{ride?.captain?.type || "Vehicle Model"}</p>
            </div>
          </div>
          <div className="w-full">
            ...
            <div className="flex items-center gap-5 m-2 p-2 border-b-2">
              ...
              <div>
                <h3 className="text-lg font-medium">{ride?.destination?.name}</h3>
