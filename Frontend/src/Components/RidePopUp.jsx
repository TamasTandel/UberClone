...
const RidePopUp = (props) => {
  const { selectedUser } = props; // Receive the selected user object
  ...
  return (
    <div className=''>
        ...
        <div className='flex w-full items-center justify-between bg-yellow-300 rounded-full p-2'>
            ...
            <h5 className='text-lg font-bold mr-3'>{selectedUser?.distance} KM</h5>
        </div>
        ...
        <div className='flex flex-col gap-2 justify-between items-center'>
            <div className='w-full'>
                ...
                <div>
                    <h3 className='text-lg font-medium'>{selectedUser?.location?.lat}, {selectedUser?.location?.lng}</h3>
                ...
                <div>
                    <h3 className='text-lg font-medium'>{selectedUser?.destination?.lat}, {selectedUser?.destination?.lng}</h3>
                ...
                <div>
                    <h3 className='text-lg font-medium'>${selectedUser?.fee}</h3>
            ...
            <div className='flex w-full gap-2'>
                ...
                <button
                    ...
                    className='w-full mt-5 bg-gray-200 text-gray-700 font-semibold rounded-lg p-2 text-lg'>
                    Reject
                </button>
            </div>
        </div>
