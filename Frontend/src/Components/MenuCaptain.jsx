...
const MenuCaptain = ({ onClose, allRides, fetchRideDetails }) => {
  ...
  return (
    <div className="fixed inset-0 bg-white z-50 p-5 overflow-y-auto w-full">
      <button onClick={onClose} className="text-4xl font-bold mb-5 top-3 right-3 fixed"><i className="ri-close-fill"></i></button>
      <button onClick={handleFetchRideDetails} className="text-xl font-bold mb-5">All Rides</button>
